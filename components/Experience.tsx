...
const experiences: Job[] = [
  {
    ...
    roles: [
      {
        ...
        achievements: [
          'Lead a team of 3 consultants, responsible for delivery, onboarding, and professional development.',
          ...
          'Led data delivery for a cross-agency go-live between two public sector agencies, owned investigative analysis, go-live execution, and post-implementation validation, with one Data Consultant reporting in.',
    ...
    internalInitiatives: [
      'Founded and lead Accenture\'s partnership with Multicultural Students of CBS, managing a team of 6 to deliver 4 networking events (30-40+ attendees each) and a case competition (25+ participants).',
